# Designing a Program to Use Functions (Title)

# Reading

# This program displays step-by-step instructions for disassembling
# an Acme dryer.
...
# The startup_message function displays the program's initial 
...
def step1():
    print('Step 1: Unplug the driver and')
...
# Using the 'pass' Keyword (section)
def step1():
    pass
def step2():
    pass
